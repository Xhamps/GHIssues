defmodule TableFormatterTest do
  ...
  def split_with_thre_columns, do: TF.split_into_columns(simple_test_data, headers)

  test "split_into_columns" do
    columns = split_with_thre_columns
  ...
  test "column_widths" do
    widths = TF.widths_of(split_with_thre_columns)
    assert widths == [5, 6, 7]
  end
